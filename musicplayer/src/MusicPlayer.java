...
public class MusicPlayer extends PlaybackListener
{
    ...
    //we will need a way to store our song's details
    ...
    //we will need to keep track the index we are in the pleylist
    private int curentPlaylistIndex;

    //use JLayer library to create advanced player object which will handle playing the music
    ...
    public void setCurrenFrame(int frame)
    {
        currentFrame=frame;
    }
    ...
    public void nextSong()
    {
        ...
        if(curentPlaylistIndex+1 > playlist.size() -1) return;
        ...
        //update current song
        currentSong= playlist.get(curentPlaylistIndex);
    ...
    public void prevSong()
    {
        ...
        if (curentPlaylistIndex - 1 < 0) return; 
    ...
    //create the thread that will handle updating the slider
        ...
        new Thread(new Runnable() {
            ...
            public void run()
            {
                ...
                while (!isPaused && !songFinished && !pressedNext && !pressedPrev)
                {
                    ...
                    //minic 1 millisecond using thread.sleep
                    Thread.sleep(1);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
    ...
    public void playbackStarted(PlaybackEvent evt)
    {
        ...
        System.out.println("Palyback started");
        songFinished=false;
        pressedNext=false;
        pressedPrev=false;
    }
    ...
    public void playbackFinished(PlaybackEvent evt)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                if (curentPlaylistIndex == playlist.size() - 1) 
                {
                    //update GUI
                    musicplayerGUI.enablePlayButtonDisablePAuseButton();
                }
